  ...
  <div class="flex w-full justify-center p-6 gap-4 duration-500 min-h-screen">
    ...
    >
      ...
      <div v-if="isLoading" class="flex justify-center items-center h-screen">
        <div
          class="rounded-full h-20 w-20 bg-violet-800 items-center justify-center flex animate-ping"
        ></div>
      </div>

      <!-- Блок ответов -->
      <div v-else class="h-full px-2">
        <div class="relative h-full flex justify-center">
          <div class="h-[85vh] overflow-y-auto p-16 w-full mb-16">
            ...
            <div class="flex mb-4 cursor-pointer">
              ...
              >
                <img
                  src="https://placehold.co/200x/b7a8ff/ffffff.svg?text=Я&font=Lato"
                  alt="My Avatar"
                  class="w-8 h-8 rounded-full"
                />
              </div>
              <div
                class="max-w-96 dark:bg-white bg-slate-200 rounded-lg p-3 gap-3"
              >
                <p class="text-gray-700">артем хуесос?</p>
            ...
            <div class="flex justify-end mb-4 cursor-pointer">
              <div
                class="max-w-96 bg-indigo-500 text-white rounded-lg p-3 gap-3"
              >
                <p class="text-white">артем хуесос?</p>
          ...
          <div
            class="absolute bottom-3 w-full flex items-center gap-2 justify-center px-2"
          >
            <input
              v-model="message"
    ...
    <div class="flex justify-start w-full absolute bottom-8">
      <Switcher />
    </div>
  </div>
</template>
